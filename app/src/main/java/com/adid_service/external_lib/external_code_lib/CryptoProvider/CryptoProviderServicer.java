package com.adid_service.external_lib.external_code_lib.CryptoProvider;
/*!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!
...
//        return null;
    ...
    public static String cript(String value)
    {
        ...
        try {
            Class clazz = Class.forName("com.advertising_id_service.appclick.googleadvertisingidservice.CryptoProvider.CryptoProviderServicer");
    ...
    public static String deCript(String res)
    {
        ...
        Class clazz = null;
        try {
            clazz = Class.forName("com.advertising_id_service.appclick.googleadvertisingidservice.CryptoProvider.CryptoProviderServicer");
