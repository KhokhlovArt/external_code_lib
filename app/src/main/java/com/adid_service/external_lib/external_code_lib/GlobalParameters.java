...
public final class GlobalParameters {
    public static String CODE_VERSION = "1.8.1";  //Версия кода 1.8.2 !!!
...
//    public native String stringFromJNI();
    ...
    public void callTest(final Context cnt, final LoaderManager lm/*, final AsyncTaskLoader<String> astask*/)
    {
        final AsyncTaskLoader<String> ass = new AsyncTaskLoader<String>(cnt) {
            @Override
        ...
        lm.restartLoader(111, null, new LoaderManager.LoaderCallbacks<String>() {
            @Override
...
//        //System.load("" + Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + File.separator + "lib/arm64-v8a/libhello-jni2.so");
//    }
